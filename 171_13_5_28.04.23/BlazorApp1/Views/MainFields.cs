...
namespace BlazorApp1.Views
{
    ...
    public class MainFields
    {
        ...
        public MainFields(Order order)
        {
            ...
            orderNum.Id = MainIdNames.ORDERNUM.ToString();
            ...
            orderStatus.Id = MainIdNames.ORDERSTATUS.ToString();
            ...
            orderShortType.Id = MainIdNames.ORDERSHORTTYPE.ToString();
            ...
            orderDescription.Id = MainIdNames.ORDERDESCRIPTION.ToString();
            ...
            orderAddress.Id = MainIdNames.ORDERADDRESS.ToString();
            ...
            orderExecutorContacts.Id = MainIdNames.ORDEREXECUTORCONTACTS.ToString();
            ...
            orderContacts.Id = MainIdNames.ORDERCONTACTS.ToString();
            ...
            orderPlanDateTime.Id = MainIdNames.ORDERPLANDATETIME.ToString();
            ...
            orderStopDateTime.Id = MainIdNames.ORDERSTOPDATETIME.ToString();
            ...
            orderCreator.Id = MainIdNames.ORDERCREATOR.ToString();
            ...
            orderCreateDateTime.Id = MainIdNames.ORDERCREATEDATETIME.ToString();
