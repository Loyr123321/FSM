...
namespace BlazorApp1.Models
{
    public class OrderStatus //В Планадо это резолюции. Их можно настраивать
    {
        ...
        public static readonly string DELETED_STATUS_NAME = "Удалено";
        //public static readonly OrderStatus DELETED = new OrderStatus("DELETED", "Удалено", 9); //Статус удалено не нужен. Заявки удаляются. В истории Changes[0]="Delete"
    ...
    public class Order : AbstractHistory, IHistoryModel<Order>
    {
        ...
        public List<string> FindChanges(Order newObject)
        {
            ...
            //////////DateTime tt2 = (DateTime)this.Template.Fields[0].Value;
            //////////DateTime tt3 = (DateTime)newObject.Template.Fields[0].Value;
