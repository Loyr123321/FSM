...
namespace BlazorApp1.Models.Mobile
{
    ...
    public class TemplateFieldMobile : IField
    {
        ...
        public TemplateFieldMobile(TemplateField originalField)
        {
            ...
            {
                this.Value = new DataListMobile((DataList)originalField._value);
            }
            else
            {
                this.Value = originalField._value;
            }
    ...
    //Для получения от моб версии
    public class TemplateFieldMobileComplete
    {
        public string Id { get; set; }
        public string Type { get; set; }
        public object? Value { get; set; }
